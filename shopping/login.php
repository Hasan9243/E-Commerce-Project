...
<html lang="en">
	<head>
	    ...
	    <title>E-Commerce Shopping Mart | Sign-in | Signup</title>
...
<div class="form-group">
	    	...
	    	<input type="text" class="form-control unicase-form-control text-input" id="contactno" name="contactno" maxlength="20" required >
	  	</div>
